...
console.log(`The length of this word is ${s1.length}`);
console.log(`The first character of this word is ${s1[0]}`);
console.log(`The last character of this word is ${s1[s1.length - 1]}`);
...
console.log(s2[Math.floor(length / 2)]);
...
console.log(s4.slice(s4.length - 2, s4.length));
...
console.log(s61.slice(1, -1));
console.log(s62.slice(1, -1));
